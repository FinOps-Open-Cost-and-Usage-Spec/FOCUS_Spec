...
* **Linking Rule:** Link entity names and Glossary terms ONLY on their first occurrence per section. Exception: Functional links using different anchor text are exempt.
