...
| Networking                | Network Connectivity                  | Ground Station, VPN Gateway, PrivateLink                                  | Peering, 5G Core, Orbital, VPN Gateway, NAT Gateway, PrivateLink, Virtual WAN                                         | Shared VPC (XPN), Cloud VPN, Cloud Interconnect                    |
| Networking                | Network Infrastructure                | VPC, VPC Flow Logs                                                        | Virtual Network, Network Watcher, Network Function Manager                                                            |                                                                    |
