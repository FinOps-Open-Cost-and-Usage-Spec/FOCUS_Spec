...
* In an **entity catalog table**, the entity reference that identifies the subject of each row MAY be linked to that entity's definition, even when the entity was linked earlier in the source Markdown file. 
