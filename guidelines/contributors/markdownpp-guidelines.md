...
* Headers MUST be denoted in Title Case, with all words capitalized except articles (a, an, the), coordinating conjunctions (and, but, or), short prepositions (e.g., in, on, at), and specific technical exceptions (e.g., is, are, vs, vs.), unless they begin the subheader.
