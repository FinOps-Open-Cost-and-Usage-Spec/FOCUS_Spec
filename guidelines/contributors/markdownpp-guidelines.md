...
* Headers MUST be denoted in Title Case, subject to the following exceptions:
  * Minor words such as articles (e.g., a, an, the), coordinating conjunctions (e.g., and, but, or), short prepositions (e.g., in, on, at), and short connecting terms (i.e., is, are, vs, vs.) MUST NOT be capitalized unless they begin the subheader.
