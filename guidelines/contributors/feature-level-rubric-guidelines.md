...
One further question sits alongside these rather than inside them. The rubric constrains what a generator publishes, and does not yet say how cross-generator Supported Features behave when a Conditional column is absent. That counterpart is recorded in the design notes and is unresolved.
