...
The specification:
* must not specify that a specific technology, software package/library, or cloud service provider must be (or is recommended to be) used
* can use examples that show a specific technology, software package/library, or cloud servie provider to demonstrate a concept
