...
| ConformanceRuleId | Function | Reference | ApplicabilityCriteria | Condition | Requirement | Keyword | MustSatisfy | Type | Notes | CRVersionIntroduced | Status |
|-------------------|----------|-----------|-----------------------|-----------|-------------|---------|-------------|------|-------|-----|----|
| | | | | | | | | | | | | 
