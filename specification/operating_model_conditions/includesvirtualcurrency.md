...
The Includes Virtual Currency operating model condition represents a verifiable state indicating whether the [*operating model*](#glossary:operating-model) includes prices in [*virtual currency*](#glossary:virtual-currency).
