...
* DataType MUST be of type Boolean and MUST NOT contain null values.
* The value of deprecated should only be "true" if the column is deprecated.
* Providers can choose to always provide the deprecation key or elect to only include it when the deprecation status of a column is "true".
