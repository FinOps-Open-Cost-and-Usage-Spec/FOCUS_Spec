...
* DataGenerator MUST be present in the [Data Generator](#metadata.datagenerator) object.
* DataGenerator MUST be of type String.
* DataGenerator MUST conform to [StringHandling](#attributes.stringhandling) requirements.
