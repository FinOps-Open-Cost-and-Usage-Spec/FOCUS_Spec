...
Estimated Monthly Cost Impact represents the estimated change in [Effective Cost](#datasets.costandusage.effectivecost), over a one-month period, projected from acting on a recommendation. A negative value represents a cost saving while a positive value represents an increase in cost. Estimated Monthly Cost Impact can be used to prioritize recommendations and to quantify the aggregate opportunity across a portfolio of recommendations without normalizing across different time windows.
