...
* When ContractCommitmentDurationType is not null, ContractCommitmentDurationType MUST adhere to the following requirements:
  * ContractCommitmentDurationType SHOULD be expressed with a quantity and unit, where quantity is a positive integer and unit is a standardized unit of time or usage, either singular or plural (e.g., "1 Year", "3 Years", "100 DPUs").
