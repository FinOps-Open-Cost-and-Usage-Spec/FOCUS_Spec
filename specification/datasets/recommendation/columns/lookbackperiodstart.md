...
* When LookbackPeriodStart is not null, LookbackPeriodStart MUST adhere to the following requirements:
  * LookbackPeriodStart MUST be less than [LookbackPeriodEnd](#datasets.recommendation.lookbackperiodend).
