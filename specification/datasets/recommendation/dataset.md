...
| [Resource Type](#datasets.recommendation.resourcetype) | Dimension | Conditional | True | String |
...
* Recommendation column presence MUST adhere to the following requirements:
  ...
  * Recommendation MUST include [ResourceType](#datasets.recommendation.resourcetype) when a recommendation is associated with a single resource.
