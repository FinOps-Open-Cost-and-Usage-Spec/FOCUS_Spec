...
The ContractId column MUST adhere to the following requirements:
...
* When ContractId is not null, ContractId MUST adhere to the following additional requirements:
