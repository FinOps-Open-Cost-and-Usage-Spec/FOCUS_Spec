...
* When a contract has multiple [*commitment tiers*](#glossary:commitment-tier) (e.g., 5% discount up to 1M, 10% above 1M), ContractCommitmentDiscountPercentage MUST adhere to the following additional requirements:
