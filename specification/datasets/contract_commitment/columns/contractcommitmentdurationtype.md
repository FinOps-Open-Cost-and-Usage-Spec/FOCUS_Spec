...
* ContractCommitmentDurationType SHOULD present the unit of time as one of the allowed time-based unit names defined by [UnitFormat](#attributes.unitformat).
