...
* ContractCommitmentDurationType SHOULD present the unit of time as one of the allowed time-based unit names defined by [UnitFormat](#attributes.unitformat), from Minute through Year.
...
* ContractCommitmentDurationType MUST use the largest time-based unit defined by UnitFormat that expresses the duration as a whole number (e.g., "1 Year" rather than "12 Months", "1 Week" rather than "7 Days").
