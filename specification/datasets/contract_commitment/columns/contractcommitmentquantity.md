...
The ContractCommitmentQuantity column MUST adhere to the following requirements:
...
* The ContractCommitmentQuantity column MUST adhere to the following nullability requirements:
