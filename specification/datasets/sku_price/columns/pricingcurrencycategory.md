...
| Consumable | The pricing currency represents a service-provider-specific [*consumption currency*](#glossary:consumption-currency) (e.g., platform credits, normalized billing units). Math resulting from this rate yields a virtual cost balance within the provider's ecosystem, requiring a mandatory secondary conversion to determine the financial cost. |
