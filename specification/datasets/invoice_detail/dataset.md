...
* InvoiceDetail MUST include a custom column to represent any cost or monetary metric that appears on an invoice issued to a BillingAccountId when there is no equivalent FOCUS column.
