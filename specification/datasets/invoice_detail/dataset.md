...
* InvoiceDetail MUST include custom columns to represent any cost or monetary metric that appears on an invoice issued to a BillingAccountId when there is no equivalent FOCUS column.
