...
* InvoiceDetail MUST include a custom column (e.g., x_PricingQuantity) to represent any metric that appears on an invoice issued to a BillingAccountId when there is no equivalent FOCUS column.
