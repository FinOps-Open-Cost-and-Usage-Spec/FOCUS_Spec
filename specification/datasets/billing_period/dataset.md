...
* BillingPeriod columns MUST conform to [ColumnHandling](#attributes.columnhandling) requirements.
* BillingPeriod columns MUST conform to [NullHandling](#attributes.nullhandling) requirements.
