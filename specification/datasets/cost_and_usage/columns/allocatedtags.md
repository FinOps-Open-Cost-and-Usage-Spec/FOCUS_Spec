...
The AllocatedTags column MUST adhere to the following requirements:

* AllocatedTags MUST conform to [KeyValueFormat](#attributes.key-valueformat) requirements.
* The AllocatedTags column MUST adhere to the following nullability requirements:
...
* When AllocatedTags is not null, AllocatedTags MUST adhere to the following additional requirements:
...
* The Data generator-defined tags MUST adhere to the following additional requirements:
...
* The User-defined tags MUST adhere to the following additional requirements:
