...
The Allocated Tags column represents the set of tags assigned to tag sources which are specifically applicable to allocated charges resulting from a provider-calculated split cost allocation.
