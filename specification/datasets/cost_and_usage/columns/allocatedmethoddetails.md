...
* AllocatedMethodDetails SHOULD be present in a cost and usage [*FOCUS dataset*](#glossary:FOCUS-dataset) when the service provider supports [Provider-Calculated Split Cost Allocation](#ProviderCalculatedSplitCostAllocation).
