...
The Tags column MUST adhere to the following requirements:

* Tags MUST conform to [KeyValueFormat](#attributes.key-valueformat) requirements.
* Tags MAY be null.
* When Tags is not null, Tags MUST adhere to the following additional requirements:
...
* The Provider-defined tags MUST adhere to the following additional requirements:
