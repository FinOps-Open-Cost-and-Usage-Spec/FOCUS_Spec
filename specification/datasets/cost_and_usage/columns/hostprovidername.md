...
* HostProviderName values are defined as follows:
  ...
  * HostProviderName MUST reflect the name of the host provider when the service provider does not provide visibility into the underlying hosting provider.
