...
The ContractedUnitPrice column MUST adhere to the following requirements:
...
* When ContractedUnitPrice is not null, ContractedUnitPrice MUST adhere to the following additional requirements:
