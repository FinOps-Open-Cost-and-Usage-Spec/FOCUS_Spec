...
* ContractApplied MUST be present in a [*FOCUS dataset*](#glossary:FOCUS-dataset) when the service provider supports *contract commitments*.
...
* "ContractId" MUST be present in a [*FOCUS dataset*](#glossary:FOCUS-dataset) when the service provider supports *contract commitments*.
...
* "ContractCommitmentID" MUST be present in a [*FOCUS dataset*](#glossary:FOCUS-dataset) when the service provider supports *contract commitments*.
...
* "ContractCommitmentAppliedCost" MUST be present in a [*FOCUS dataset*](#glossary:FOCUS-dataset) when the service provider associates the *charge's* value with one or more *contract commitments*.
...
* "ContractCommitmentAppliedQuantity" MUST be present in a [*FOCUS dataset*](#glossary:FOCUS-dataset) when the service provider associates the *charge's* quantity with one or more *contract commitments*.
...
* "ContractCommitmentAppliedUnit" MUST be present in a [*FOCUS dataset*](#glossary:FOCUS-dataset) when the service provider associates the *charge's* quantity with one or more *contract commitments*.
