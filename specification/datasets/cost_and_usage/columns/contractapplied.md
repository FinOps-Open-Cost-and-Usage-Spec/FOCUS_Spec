...
* ContractAppliedObject.Elements[\*].ContractCommitmentId MUST be equal to ResourceId when ChargeCategory is "Usage" and the *charge* represents an unused portion of that *contract commitment*.
