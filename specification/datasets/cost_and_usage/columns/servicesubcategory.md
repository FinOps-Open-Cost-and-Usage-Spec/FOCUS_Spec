...
| Compute                   | Virtual Machines                      | Computing environments provisioned as virtualized hosts with a provider-managed hypervisor abstracting the underlying hardware, whether shared or single-tenant. |
