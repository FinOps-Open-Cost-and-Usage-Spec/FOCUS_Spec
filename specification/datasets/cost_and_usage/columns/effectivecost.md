...
For all *charges*, Effective Cost reflects all applicable pricing adjustments, such as reduced pricing from [*negotiated discounts*](#glossary:negotiated-discount) or [*commitment discounts*](#glossary:commitment-discount). For usage *charges*, Effective Cost includes the consumed or recognized portion of *Billed Cost* from a related purchase charge (e.g. amortized portions of prepayments, draw downs). For purchase *charges*, Effective Cost excludes any amounts recognized or will be recognized in related usage *charges* (e.g., usage covered by *commitments*, pre-payments, or marketplace purchases which draw down based on usage), regardless of when those related *charges* are invoiced.
