...
The AllocatedMethodId column MUST adhere to the following requirements:
...
* The AllocatedMethodId column MUST adhere to the following nullability requirements:
