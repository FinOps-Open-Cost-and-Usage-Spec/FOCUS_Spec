...
* When SkuPriceDetails is not null, SkuPriceDetails MUST adhere to the following requirements:
  ...
  * SkuPriceDetails SHOULD include TokenCacheAction when the *SKU Price* meters tokens consumed from a request.
