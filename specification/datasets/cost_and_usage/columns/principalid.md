...
Principal ID is used in conjunction with [Consumer ID](#datasets.costandusage.consumerid) when the party a *charge* is attributed to differs from the *principal* the service provider authenticated.
