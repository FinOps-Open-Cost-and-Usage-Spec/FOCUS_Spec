...
* CostAndUsage column presence MUST adhere to the following requirements:
  ...
  * CostAndUsage MUST include [CommitmentProgramEligibilityDetails](#datasets.costandusage.commitmentprogrameligibilitydetails) when the *source operating model* [includes commitment programs](#presenceconditions.includescommitmentprograms).
