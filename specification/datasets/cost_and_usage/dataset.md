...
| [Principal ID](#datamodel.costandusage.principalid)                                                  | Dimension          | [Conditional](#conditions.includesidentityattribution) | True         | String    |
...
* CostAndUsage column presence MUST adhere to the following requirements:
  ...
  * CostAndUsage MUST include [PrincipalId](#datamodel.costandusage.principalid) when the *operating model* [includes identity attribution](#conditions.includesidentityattribution).
