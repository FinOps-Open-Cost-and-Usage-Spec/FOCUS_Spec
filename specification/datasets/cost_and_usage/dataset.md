...
| [Commitment Program Eligibility](#datasets.costandusage.commitmentprogrameligibility)                           | Dimension          | Conditional   | True         | JSON    |
...
* CostAndUsage column presence MUST adhere to the following requirements:
  ...
  * CostAndUsage MUST include [CommitmentProgramEligibility](#datasets.costandusage.commitmentprogrameligibility) when the service provider supports at least one [*commitment program*](#glossary:commitment-program).
