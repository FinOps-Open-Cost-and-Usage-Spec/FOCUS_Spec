...
* CostAndUsage SHOULD include [*custom columns*](#glossary:custom-column) needed to identify applied discounts when [*FOCUS columns*](#glossary:FOCUS-column) are not sufficient.
