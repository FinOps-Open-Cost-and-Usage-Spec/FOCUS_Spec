...
* CostAndUsage column presence MUST adhere to the following requirements:
  ...
  * CostAndUsage MUST include [ListUnitPrice](#datamodel.costandusage.listunitprice) when the *operating model* [includes unit pricing](#conditions.includesunitpricing).
