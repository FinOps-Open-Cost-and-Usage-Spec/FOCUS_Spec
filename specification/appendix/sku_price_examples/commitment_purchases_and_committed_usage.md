...
* The reservation fees are 1893.600000, 1998.800000, and 2104.000000 for "All Upfront", "Partial Upfront", and "No Upfront". [PricingUnit](#datamodel.skuprice.pricingunit) is "Units", so each fee is the price of one reservation, and PurchaseDurationType of "1 Year" states the term that reservation runs for. How the fee is collected is what the payment model names, and it is not visible in the price.
