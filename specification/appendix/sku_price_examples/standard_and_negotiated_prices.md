...
* The negotiated rate names the entities that can receive it. The `Inclusions` array carries one rule per dimension, and `InclusionOperator` states how multiple rules combine:
