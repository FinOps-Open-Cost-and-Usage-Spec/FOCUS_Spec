...
| Savings Plan - 150% Utilization     | [aws_savings_plan_all_upfront_150pct](aws_savings_plan_all_upfront_150pct.md)                   | What happens when demand exceeds commitment capacity. The first 24 hours apply the committed rate; 12 additional hours spill over to on-demand at full list price (`PricingCategory=Standard`).       |
