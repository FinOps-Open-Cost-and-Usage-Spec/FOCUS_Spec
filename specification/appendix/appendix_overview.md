...
| [Examples: Data Generator-Calculated Split Cost Allocation](#appendix.examples:datageneratorcalculatedsplitcostallocation) | Demonstrates how AllocatedServiceName and AllocatedServiceCategory identify the consumer service on allocated charges while the origin service dimensions are preserved. |
