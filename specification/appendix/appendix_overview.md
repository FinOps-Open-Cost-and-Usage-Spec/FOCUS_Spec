...
| [Examples: Actor Attribution](#appendix.examples:actorattribution) | Illustrates how Principal ID and Consumer ID are populated across different technology categories to resolve asymmetric actor granularity. |
