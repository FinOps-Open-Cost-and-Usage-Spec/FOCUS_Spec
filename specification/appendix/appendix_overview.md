...
| [Examples: Data Generator-Calculated Split Cost Allocation](#appendix.examples:datageneratorcalculatedsplitcostallocation) | Demonstrates how Allocated Service Name enables consumer service identification on allocated charges while origin dimensions are preserved per Data Generator-Calculated Split Cost Allocation Handling, using a worked example of a shared resource split across multiple consumer services with origin-side and consumer-side cost analysis. |
