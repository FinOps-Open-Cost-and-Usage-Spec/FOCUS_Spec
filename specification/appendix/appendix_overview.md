...
| [Examples: Actor Attribution](#appendix.examples:actorattribution) | Illustrates how Principal ID and Consumer ID are populated across different technology categories when the party a charge is attributed to differs from the principal. |
