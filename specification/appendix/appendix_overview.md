...
| [Examples: Commitment Program Eligibility Details](#appendix.examples:commitmentprogrameligibilitydetails) | Demonstrates how CommitmentProgramEligibilityDetails interacts with capacity reservation columns for capacity reservation programs. |
