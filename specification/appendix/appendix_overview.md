...
| [Examples: Data Generator-Calculated Split Cost Allocation](#appendix.examples:datageneratorcalculatedsplitcostallocation) | Demonstrates how the Allocated Service Name and Allocated Service Category columns identify the consumer service on allocated charges while the origin service dimensions are preserved. |
