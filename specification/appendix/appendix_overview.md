...
| [Examples: Data Generator-Calculated Split Cost Allocation](#appendix.examples:datageneratorcalculatedsplitcostallocation) | Demonstrates how the Allocated Service Name column identifies the consumer service on allocated charges while the origin service dimensions are preserved. |
