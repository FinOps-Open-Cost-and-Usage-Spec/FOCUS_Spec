...
| [Examples: Data Generator-Calculated Split Cost Allocation](#appendix.examples:datageneratorcalculatedsplitcostallocation) | Demonstrates the row-splitting transformation data generators must perform when mapping native billing data into FOCUS split allocation rows, shows how Allocated Service Name enables consumer service identification, and provides practitioner query patterns for origin-side and consumer-side cost analysis. |
