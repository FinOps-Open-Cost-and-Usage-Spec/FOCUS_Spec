...
| [Examples: Split Cost Allocation Field Mapping](#appendix.examples:splitcostallocationfieldmapping) | Provides a complete column-by-column field mapping showing how a data generator transforms native billing data (column-augmentation format) into FOCUS split allocation rows, with metric reconciliation verification. |
