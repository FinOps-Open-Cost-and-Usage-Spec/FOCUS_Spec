...
| [Examples: Pricing Region Scope](#appendix.examples:pricingregionscope) | Illustrates how to distinguish a price that applies across a broad geographic area from one pinned to a narrower area in a Cost and Usage FOCUS dataset, including a third data zone scope and the price difference between scopes. |
