...
| [Examples: AI Billing](#appendix.examples:aibilling) | Illustrates how to represent usage-based billing for foundation model APIs in a Cost and Usage FOCUS dataset, including direct billing, marketplace resale, first-party CSP offerings, commitment drawdown, and multi-model invoices with cached token charges. |
