...
CrestNode has decided to deprecate columns prior to removal from their FOCUS data export. The column for deprecation is x_awesome_column3. The data generator creates a new [Schema](#metadata.schema) object to represent the new schema, with a unique [SchemaId](#metadata.schema.schemaid).
