...
* Solora AI is both the [*service provider*](#glossary:service-provider) and the [*invoice issuer*](#glossary:invoice-issuer), so [ServiceProviderName](#datamodel.costandusage.serviceprovidername), [HostProviderName](#datamodel.costandusage.hostprovidername), and [InvoiceIssuerName](#datamodel.costandusage.invoiceissuername) are all "Solora AI".
