...
* On the usage rows, [BilledCost](#datamodel.costandusage.billedcost) is $0.00 while [EffectiveCost](#datamodel.costandusage.effectivecost) carries the amortized drawdown ($25.00 input and $37.50 output), matching the covering-purchase pattern used elsewhere for commitment discounts.
