# Frontier Model via CSP Marketplace
...
[**CSV Example**](/specification/data/ai_billing/frontier_model_via_csp_marketplace.csv)
...
* [InvoiceIssuerName](#datamodel.costandusage.invoiceissuername) is "Aura Web" while [ServiceProviderName](#datamodel.costandusage.serviceprovidername) and [HostProviderName](#datamodel.costandusage.hostprovidername) are "Solora AI", matching scenario 3.3.2 in [Participating Entity Identification](#appendix.examples:participatingentityidentification), where the marketplace offering does not run on the cloud provider's infrastructure and the underlying hosting provider is not visible.
