...
Similarly, practitioners rely on the aggregated Billed Costs in the Invoice Detail dataset to equal the aggregated [Billed Costs](#datasets.costandusage.billedcost) in the Cost and Usage dataset for the same identifiers.
