...
The Includes Multiple Billing Account Types condition represents a verifiable state indicating whether the [*operating model*](#glossary:operating-model) includes more than one possible BillingAccountType value.
...
A verifiable state indicating whether the *operating model* includes more than one possible BillingAccountType value.
