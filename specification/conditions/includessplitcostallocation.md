...
The Includes Split Cost Allocation condition represents a verifiable state where the operating model includes logic for distributing the cost or usage of a single origin charge across multiple entities.
