...
The Includes Availability Zones condition represents a verifiable state indicating whether the [*operating model*](#glossary:operating-model) includes deploying resources or services within an availability zone.
