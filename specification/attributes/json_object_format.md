...
* Objects used within JsonObjectFormat MUST adhere to the following requirements:
...
* Arrays used within JsonObjectFormat MUST adhere to the following requirements:
