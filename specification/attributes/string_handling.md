...
* When [*FOCUS column*](#glossary:FOCUS-column) contains string values, *FOCUS column* MUST adhere to the following requirements:
...
* When [*custom column*](#glossary:custom-column) contains string values, *custom column* MUST adhere to the following requirements:
