...
| [Dataset Configuration](#attributes.datasetconfiguration) | Defines the rules for customizing a dataset's schema, including additional columns populated for specific records. |
