...
* Temporal accuracy - capturing both when the [*charge*](#glossary:charge) was incurred (reflected in [*charge period*](glossary:chargeperiod) columns, i.e., [Charge Period Start](#datasets.contractcommitment.chargeperiodstart) and [Charge Period End](#datasets.contractcommitment.chargeperiodend)) and when the correction was invoiced (reflected in [*billing period*](#glossary:billing-period) columns, i.e., [Billing Period Start](#datasets.contractcommitment.billingperiodstart) and [Billing Period End](#datasets.contractcommitment.billingperiodend)).
...
* Cost allocation and chargeback - attributing corrections to the correct dimensions (e.g., [Billing Account ID](#datasets.contractcommitment.billingaccountid), [Sub Account ID](#datasets.contractcommitment.subaccountid), [SKU ID](#datasets.contractcommitment.skuid), [SKU Price ID](#datasets.contractcommitment.skupriceid), [Resource ID](#datasets.contractcommitment.resourceid)) to ensure accurate downstream processing.
