...
* <a name="column_handling:custom-column">Custom (e.g., provider-defined) columns</a> that are not defined by FOCUS but included in a *FOCUS dataset* MUST follow the following rules:
