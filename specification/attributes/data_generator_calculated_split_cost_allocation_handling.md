...
* [*FOCUS dataset*](#glossary:FOCUS-dataset) column values in *allocated charges* MUST match the corresponding value in the *origin charge* when the *FOCUS dataset* column represents a dimension.
