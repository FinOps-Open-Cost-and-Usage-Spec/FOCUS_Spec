...
* [*FOCUS column*](#glossary:FOCUS-column) values in *allocated charges* MUST match the corresponding value in the *origin charge* when the *FOCUS column* represents a non-summable *metric* (e.g., unit prices).
