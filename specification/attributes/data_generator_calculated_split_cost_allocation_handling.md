...
* [*FOCUS dataset*](#glossary:FOCUS-dataset) column values in *allocated charges* MUST match the corresponding value in the *origin charge* when the *FOCUS column* represents a dimension.
* *FOCUS dataset* column values in *allocated charges* MUST match the corresponding value in the *origin charge* when the *FOCUS column* represents a non-summable [*metric*](#glossary:metric) (e.g., unit prices).
* The sum of *FOCUS dataset* column values in *allocated charges* MUST match the corresponding value in the *origin charge* when the *FOCUS column* represents a summable *metric* (e.g., costs and quantities).
