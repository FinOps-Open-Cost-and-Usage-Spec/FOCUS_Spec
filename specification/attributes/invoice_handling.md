...
Any necessary modifications to previously *closed billing period* that have financial impact and require issuing additional invoices must instead be reflected in a subsequent [*open billing period*](#glossary:open-billing-period), with the charge period indicating when the cost was incurred.
