...
* A FOCUS dataset MUST include the following columns when the provider supports service-provider-calculated split cost allocation:
...
* A FOCUS dataset SHOULD include the following column when the provider supports service-provider-calculated split cost allocation:
