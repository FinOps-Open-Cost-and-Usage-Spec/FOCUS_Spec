...
All columns defined in FOCUS MUST follow the null handling requirements listed below. Custom columns SHOULD also follow these same null handling requirements.
