...
When [ChargeCategory](#chargecategory) is "Usage" and [CommitmentDiscountStatus](#commitmentdiscountstatus) is "Unused", ListUnitPrice MUST reflect the corresponding [*commitment-based discount's*](#glossary:commitment-based-discount) purchase's ContractCost value, or be zero if no purchase record exists.
