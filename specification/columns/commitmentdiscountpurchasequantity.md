...
* CommitmentDiscountPurchaseQuantity value MUST be the total, positive amount of units, denoted by [CommitmentDiscountUnit](#commitmentdiscountunit), available for a *commitment-based discount* across its [*term*](#glossary:term) at the time of an applicable purchase.
