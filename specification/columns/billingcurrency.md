...
[Billing Currency](glossary:billing-currency) is an identifier that represents the currency that a [*charge*](#glossary:charge) for resources and/or services was billed in. Billing Currency is commonly used in scenarios where costs need to be grouped or aggregated.
