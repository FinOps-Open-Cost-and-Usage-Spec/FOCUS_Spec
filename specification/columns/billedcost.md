...
* The sum of the BilledCost for [*charges*](#glossary:charge) in a given [*billing period*](#glossary:billing-period), [*billing account*](#glossary:billing-account), and an [InvoiceId](#invoiceid), MUST match the sum of the payable amount provided in the corresponding invoice with the same id generated by the [InvoiceIssuer](#InvoiceIssuer).
* BilledCost MUST be zero for *charges* where payments are received by a third party (e.g., marketplace transactions).
