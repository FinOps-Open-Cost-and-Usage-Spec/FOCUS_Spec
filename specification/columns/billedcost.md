...
The BilledCost column MUST be present in the billing data and MUST NOT be null. This column MUST be of type Decimal, MUST conform to [Numeric Format](#numericformat), and be denominated in the BillingCurrency. The aggregated BilledCost for a [*billing period*](#glossary:billing-period) MUST match the charge received on the invoice for the same *billing period*.
