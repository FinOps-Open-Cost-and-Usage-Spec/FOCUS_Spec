...
* The sum of the BilledCost for [*rows*](#glossary:row) in a given [*billing period*](#glossary:billing-period), [*billing account*](#glossary:billing-account), and an invoiceId, MUST match the sum of the [*charges*](#glossary:charge) provided in the corresponding invoice with the same id, as generated by the InvoiceIssuer.
