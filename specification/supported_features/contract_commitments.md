...
The Contract Applied column contains several FOCUS-defined properties. For more information, see the definition of Contract Applied [here](#datamodel.costandusage.contractapplied).
...
The FOCUS specification implements the application of contract commitments to cost and usage via the [*ContractApplied*](#datamodel.costandusage.contractapplied) column, which is defined in [*JSON object format*](#attributes.jsonobjectformat).
