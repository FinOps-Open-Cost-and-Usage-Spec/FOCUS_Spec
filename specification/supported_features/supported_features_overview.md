...
| [Recommendations](#supportedfeatures.recommendations) | Normalizes optimization recommendations from service providers and third-party tooling so they can be prioritized and joined to cost and usage data. |
