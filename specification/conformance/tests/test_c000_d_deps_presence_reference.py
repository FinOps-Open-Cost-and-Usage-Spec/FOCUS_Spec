...
def _collect_nested_d_rules(root_rule_id, rules, visited=None):
    """
    Depth-first collect all -D- ConformanceRuleIds reachable from a D rule via
    ValidationCriteria.Requirement/Condition trees (following ConformanceRuleId links).
    ...
    while stack:
        ...
        for root_key in ("Requirement", "Condition"):
            ...
            for ref in _iter_values_for_key(root, "ConformanceRuleId"):
