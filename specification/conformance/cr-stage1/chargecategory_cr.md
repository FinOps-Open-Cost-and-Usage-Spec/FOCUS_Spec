...
| ChargeCategory-C-001-M | Presence         | Charge Category | MUST     | Dataset includes ChargeCategory column | All_Rows | MUST be present in a FOCUS dataset         | null                                                                                                | static | 1.2                 | active |       |
