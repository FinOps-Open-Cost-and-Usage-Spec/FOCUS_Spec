...
| ------------------------- | ---------------- | ------------------ | ----------- | --------------------- | --------- | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ------ | ------------------- | ------ | ----------------------------------------- |
| ChargeDescription-C-000-M | Composite        | Charge Description | MUST/SHOULD | All Rows              | All Rows  | All ChargeDescription rules MUST be enforced                                                   | AND(ChargeDescription-D-001-M, ChargeDescription-C-002-M, ChargeDescription-C-003-M, ChargeDescription-C-004-O, ChargeDescription-C-005-O) | static | 1.2                 | active |                                           |
| ChargeDescription-D-001-M | Presence         | Charge Description | MUST        | All Rows              | All Rows  | ChargeDescription MUST be present in a FOCUS dataset                                           | null                                                                                                                                       | static | 1.2                 | active |                                           |
...
| ChargeDescription-C-003-M | Validation       | Charge Description | MUST        | All Rows              | All Rows  | ChargeDescription MUST conform to StringHandling requirements                                  | StringHandling\:CR                                                                                                                         | static | 1.2                 | active | Cross-attribute reference: StringHandling |
...
| ChargeDescription-C-005-O | Validation       | Charge Description | SHOULD      | All Rows              | All Rows  | ChargeDescription maximum length SHOULD be provided in the corresponding FOCUS Metadata Schema | null                                                                                                                                       | static | 1.2                 | active |                                           |
