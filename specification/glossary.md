...
A commitment model in which a customer gradually contributes ("builds up") toward predefined target amount(s) over time, with invoicing aligned to actual resource or service consumption. The customer agrees to commitment terms and conditions, including, but not limited to, a predefined commitment amount, a commitment [*term*](#glossary:term) (e.g., one or two years), and a [*commitment interval*](#glossary:commitment-interval) (e.g., monthly or yearly). This commitment may be structured either as spend-based (defined by monetary value) or usage-based (defined by the quantity of resources or services). The total committed amount is typically distributed evenly across defined *commitment intervals*, with contributions tracked accordingly. If the target for a given interval is not met, a true-up charge may apply. Commitments are generally made in exchange for commercial benefits, such as discounted pricing. Build-Up Commitments are typically offered as [*Negotiated Build-Up Commitments*](#glossary:negotiated-build-up-commitment). While [*Non-Negotiated Build-Up Commitments*](#glossary:non-negotiated-build-up-commitment) also exist, they are less common.

<a name="glossary:burn-down-commitment"><b>Burn-Down Commitment</b></a>

A commitment model in which a customer gradually consumes ("burns down") predefined amount(s) over time, with invoicing based on a predefined payment schedule (e.g., All-Upfront, Partial Upfront, or No-Upfront). The customer agrees to commitment terms and conditions, including, but not limited to, a predefined commitment amount, a commitment [*term*](#glossary:term) (e.g., one or two years), a [*commitment interval*](#glossary:commitment-interval) (e.g., hourly, monthly, yearly, or custom). and a payment model (either  All-Upfront, Partial Upfront, or No-Upfront). This commitment may be structured either as spend-based (defined by monetary value) or usage-based (defined by the quantity of resources or services). The total committed amount is typically distributed evenly across defined *commitment intervals*, with consumption tracked accordingly. Any unused portion may expire at the end of a *commitment interval* and cannot be carried over. Commitments are generally made in exchange for commercial benefits, such as discounted pricing, and may include provider obligations related to resource availability or service levels. Burn-Down Commitments may be offered as [*Negotiated Burn-Down Commitments*](#glossary:negotiated-burn-down-commitment)] or [*Non-Negotiated Burn-Down Commitments*](#glossary:non-negotiated-burn-down-commitment).
...
See [*Non-Negotiated Burn-Down Commitment*](#glossary:non-negotiated-burn-down-commitment).
