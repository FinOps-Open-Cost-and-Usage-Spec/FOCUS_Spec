...
For complete guidance, see [AI Usage Guidelines](guidelines/contributor/ai-usage-guidelines.md).
...
> For further details on how to work with Git and GitHub, refer to the [GitHub Guidelines](https://github.com/FinOps-Open-Cost-and-Usage-Spec/FOCUS_Spec/blob/working_draft/guidelines/contributor/github-guidelines.md).
...
> For details about labels and stages, see [Git Issues - Project - Content Creation](https://github.com/FinOps-Open-Cost-and-Usage-Spec/FOCUS_Spec/blob/working_draft/guidelines/contributor/development-processes.md#focus-development-process)
...
> Visit [Editorial Guidelines](https://github.com/FinOps-Open-Cost-and-Usage-Spec/FOCUS_Spec/blob/working_draft/guidelines/contributor/editorial-guidelines.md) for further information.
