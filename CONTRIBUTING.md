...
> For further details on how to work with Git and GitHub, refer to the [GitHub Guidelines](https://github.com/FinOps-Open-Cost-and-Usage-Spec/FOCUS_Spec/blob/working_draft/guidelines/contributors/github-guidelines.md).
...
> For details about labels and stages, see [Git Issues - Project - Content Creation](https://github.com/FinOps-Open-Cost-and-Usage-Spec/FOCUS_Spec/blob/working_draft/guidelines/contributors/development-processes.md#focus-development-process)
...
> Visit [Editorial Guidelines](https://github.com/FinOps-Open-Cost-and-Usage-Spec/FOCUS_Spec/blob/working_draft/guidelines/contributors/editorial-guidelines.md) for further information.
