...
| **#12: Circular rule dependency**<br><br>*(Defect carried over from the 1.2 Requirements Model)* | `commitmentdiscountunit.json` | `CAU-CommitmentDiscountUnit-C-005-C` and `CAU-CommitmentDiscountUnit-C-006-C` declared a dependency on the composite rule `CAU-CommitmentDiscountQuantity-C-000-C`, which itself resolves back through the `CommitmentDiscountUnit` rules and closed a dependency cycle. Neither rule referenced `CAU-CommitmentDiscountQuantity-C-000-C` in its logic, which is a `CheckValue` on the column only. | The dependency was narrowed to `CAU-CommitmentDiscountQuantity-C-003-C`, the nullability requirement the two rules actually rely on, breaking the cycle. | Issue: [#2536](https://github.com/FinOps-Open-Cost-and-Usage-Spec/FOCUS_Spec/issues/2536)<br>PR: [#2609](https://github.com/FinOps-Open-Cost-and-Usage-Spec/FOCUS_Spec/pull/2609) |
...
| **#4: Circular rule dependency** | `commitmentdiscountunit.json` | `CommitmentDiscountUnit-C-005-C` and `CommitmentDiscountUnit-C-006-C` declared a dependency on the composite rule `CommitmentDiscountQuantity-C-000-C`, which itself resolves back through the `CommitmentDiscountUnit` rules and closed a dependency cycle. Neither rule referenced `CommitmentDiscountQuantity-C-000-C` in its logic, which is a `CheckValue` on the column only. | The dependency was narrowed to `CommitmentDiscountQuantity-C-003-C`, the nullability requirement the two rules actually rely on, breaking the cycle. | Issue: [#2536](https://github.com/FinOps-Open-Cost-and-Usage-Spec/FOCUS_Spec/issues/2536)<br>PR: [#2609](https://github.com/FinOps-Open-Cost-and-Usage-Spec/FOCUS_Spec/pull/2609) |
